...
import GivingSadaqahContactContent from '@components/_external-pages/whitelabel/giving-sadaqah/GivingSadaqahContactContent';
import GivingSadaqahLayout from '@layouts/givingsadaqah';
import IqamGlobalLayout from '@layouts/iqamglobal';
import IqamGlobalContactContent from '@components/_external-pages/whitelabel/iqamglobal/IqamGlobalContactContent';
...
export default function GivingSadaqahContactPage({
  organizationRes,
  appearanceRes,
}: OrganizationHomePageProps) {
